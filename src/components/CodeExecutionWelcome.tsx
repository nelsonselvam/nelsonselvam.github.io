                            ...
                            >
                                ...
                                <pre className={`${textClass} whitespace-pre-wrap`}>
                                    <code>
                                        ...
                                        {visibleJsonLines >= 15 && '\n    '}{visibleJsonLines >= 15 && <span className="text-cyan-400">"current_project"</span>}{visibleJsonLines >= 15 && ': '}{visibleJsonLines >= 15 && <span className="text-green-400">"Commission Calculator - Web App Development"</span>}{visibleJsonLines >= 15 && ','}
